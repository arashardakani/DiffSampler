...
class Sgn(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        print('input', input)
        print(grad_input)
        print(grad_input * (1 - torch.nn.functional.tanh(input[0])**2))
        print('end')'''
        #print(grad_input)
...
class Amp(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        print('end')'''
        #print(grad_input)
        #print(grad_input.sign().shape, input.shape)
        #print(torch.sigmoid(grad_input.sign() * input[0]))
        #print(grad_input * torch.sigmoid(grad_input.sign() * input[0] + 2.))
